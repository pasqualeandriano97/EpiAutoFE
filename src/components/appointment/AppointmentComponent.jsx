...
const AppointmentComponent = () => {
  ...
  return (
    <Container fluid className="appointmentBg">
      <Container style={{ paddingTop: "150px" }}>
        <Row className="justify-content-center ">
          <Col className=" rounded-3 border-end border-1 border-dark col-12 col-md-5 cardBg">
          ...
          <Col className="rounded-3 ms-0 ms-lg-1 my-2 my-lg-0 d-flex flex-column col-12 col-md-5 cardBg">
            <div>
